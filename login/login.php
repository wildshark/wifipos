        ...
        <div class="logmod__container">
            ...
            <div class="logmod__tab-wrapper">
                ...
                <div class="logmod__tab lgm-2">
                    ...
                    <div class="logmod__form">
                        <form accept-charset="utf-8" action="login.data.php" method="post" class="simform">
                            <div class="sminputs">
                                <div class="input full">
                                    <label class="string optional" for="user-name">User ID*</label>
                                    <input name="username" class="string optional" maxlength="255" id="user-email" placeholder="Username" type="text" size="50" />
                                </div>
                            </div>
                            <div class="sminputs">
                                <div class="input full">
                            ...
                            <div class="simform__actions">
                                <button class="sumbit" name="commit" type="sumbit" value="Log-In">Log-In</button>
